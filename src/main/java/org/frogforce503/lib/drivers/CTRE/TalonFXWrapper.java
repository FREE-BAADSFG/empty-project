        ...
        if (value != mLastSet || mode != mLastControlMode) {
            ...
            switch (mode) {
                ...
                default:
                    ...
                    request = new DutyCycleOut(MathUtils.clamp(-1.0, 1.0, value));
                    break;
            }
    ...
    public void setPIDF(int slot, double kP, double kI, double kD, double kFF) {
        switch (slot) {
            case 0:
                ...
                config.Slot0.kI = kI;
                config.Slot0.kD = kD;
                config.Slot0.kS = kFF; // takes place of default feedforward
                break;
            case 1:
                config.Slot1.kP = kP;
                config.Slot1.kI = kI;
                config.Slot1.kD = kD;
                config.Slot1.kS = kFF; // takes place of default feedforward
                break;
            case 2:
                config.Slot2.kP = kP;
                config.Slot2.kI = kI;
                config.Slot2.kD = kD;
                config.Slot2.kS = kFF; // takes place of default feedforward
                break;
        }
